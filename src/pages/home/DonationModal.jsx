...
const donationAddress = import.meta.env.VITE_DONATION_WALLET || "test";
    ...
    <>
      <div className="flex flex-wrap mt-1">
        <button
          ...
          className="inline-flex mt-1 items-center rounded-full border border-indigo-200 bg-indigo-50 px-3 py-1.5 text-xs font-semibold text-indigo-600 transition hover:bg-indigo-100"
        >
          Support SoroBuild
        </button>
      </div>
